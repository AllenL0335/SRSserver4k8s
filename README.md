...
![](http://ossrs.net/gif/v1/sls.gif?site=github.com&path=/tmpl/k8s/kubernetes/AllenL0335/SRSserver4k8s)
[![](https://github.com/AllenL0335/SRSserver4k8s/actions/workflows/kubernetes.yml/badge.svg)](https://github.com/AllenL0335/SRSserver4k8s/actions/workflows/kubernetes.yml)
...
**Step 2:** Click the <kbd>Use this template</kbd> to create your repository, then set the [secrets](https://github.com/AllenL0335/SRSserver4k8s/settings/secrets/actions):

* `KUBECONFIG` is the config of K8s, for example, the content of `cat $HOME/.kube/config`.

**Step 3:** Run workflow from [Actions](https://github.com/AllenL0335/SRSserver4k8s/actions/workflows/kubernetes.yml) to deploy to your K8s, for example, if your external IP is `81.70.125.89`:
